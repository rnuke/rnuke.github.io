...
},{"@hotwired/stimulus":"byyBs","./nuke_controller/client":"kndCa","./nuke_controller/commentHandler":"3aUr9","./nuke_controller/postHandler":"3tnic","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kndCa":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Client {
    ...
    async deletePost(id, callback) {
     ...
     #request({ url , method , params , callback  } = {}) {
        if (method == "POST") return new Promise((resolve)=>setTimeout(resolve, 1000)).then(()=>console.log(url));
